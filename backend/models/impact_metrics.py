...
class ImpactMetrics(Base):
    ...
    food_waste_reduced_kg: Mapped[float] = mapped_column(Numeric(10, 2), default=0, nullable=False)
    community_reach: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
